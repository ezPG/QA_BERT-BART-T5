...
tokenizer = AutoTokenizer.from_pretrained("bert-policyQA/checkpoint-12500")
model = AutoModelForQuestionAnswering.from_pretrained("bert-policyQA/checkpoint-12500")
...
training_args = TrainingArguments(
    output_dir="/scratch/m22cs057/bert-policyQA",
